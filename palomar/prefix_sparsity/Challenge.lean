...
theorem sparsity_bound (d p r : ℕ) (hp : p > 0) (h : r ≤ d) :
    sparsity d p r h = 1 - (1 : ℚ) / (p : ℚ) ^ r := sorry

theorem sparsity_p2_r1 (d : ℕ) (h : 1 ≤ d) : sparsity d 2 1 h = 1 / 2 := sorry

theorem sparsity_p2_r3 (d : ℕ) (h : 3 ≤ d) : sparsity d 2 3 h = 7 / 8 := sorry

theorem sparsity_p2_r6 (d : ℕ) (h : 6 ≤ d) : sparsity d 2 6 h = 63 / 64 := sorry
